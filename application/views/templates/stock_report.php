    ...
    <tbody>
        <?php if($list){
           ...
           <tr>
            ...
            ?>
            <tr>
             <td colspan="6"><a style="width: auto; height:auto;   background: #2DA5DA; color: #fff; " class="btn btn-primary btn-small" href="/index.php/stock/stock_report/export" target="_blank">Export</a></td>
           </tr> 
